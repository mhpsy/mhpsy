...
const DOMAIN_NAME = 'mhpsy.com' // 域名 (不带https)
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        link: '/algorithm/',
        items: [
          { text: '2023年5月8日', link: '/pages/20230508/' },
        ],
      },
      { text: '关于', link: '/about/' },
      {
    ...
    author: {
      name: 'mhpsy', // 必需
      link: 'https://github.com/mhpsy', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Mhpsy | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
